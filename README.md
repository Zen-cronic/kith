...
- **By email** — a prepared claim, or any request that needs a grown-up, is emailed to that adult (a real Amazon SES send now that an identity is verified), so they see it even when the app is closed.
